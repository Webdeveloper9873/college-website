...
import StartCoursesImg from '../../utils/images/start-courses-image.jpg';
import FaqAccordion from '../../componenets/FaqAccordion/FaqAccordion';
    ...
    <div className='home-page'>
        <header className='h-100 min-vh-100 d-flex align-items-center text-light'>
            <div className='container d-flex flex-column align-items-center'>
                <h2>Welcome To</h2>
                <h2 className='text-center fw-semibold'>React College Gorakhpur</h2>
